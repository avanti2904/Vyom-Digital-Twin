...
function ScreenRouter() {
  ...
  // Mission completion event listener: allow continuous real-time analysis without forced screen override
  useEffect(() => {
    const handleComplete = () => {
      console.log('[VYOM] Mission milestone completion signal received. Real-time analysis continuing.');
    };
