    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div>
            <div style={{ fontSize: 9, fontFamily: 'var(--font-mono)', color: '#00d4ff', letterSpacing: '0.1em' }}>
              CURRENT MISSION
            </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
          ...
          >
            ...
            <div>
              <div style={{ fontSize: 8, fontFamily: 'var(--font-mono)', color: 'rgba(255,255,255,0.5)' }}>
                CREDITS
              </div>
              <div style={{ fontSize: 11, fontWeight: 800, color: '#00ff88', fontFamily: 'var(--font-mono)' }}>
                ∞ UNLIMITED
              </div>
            </div>
          </div>
          ...
          <div style={{ minWidth: 140 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 10, fontFamily: 'var(--font-mono)', marginBottom: 3 }}>
              ...
              <span style={{ color: resources.netPowerW >= 0 ? '#00ff88' : '#ff3b30' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 4, background: 'rgba(0,0,0,0.3)', padding: 3, borderRadius: 8 }}>
          {(['assembled', 'exploded', 'internal'] as SatelliteViewMode[]).map((mode) => (
            ...
            >
              {mode === 'assembled' ? 'ASSEMBLED' : mode === 'exploded' ? 'EXPLODED VIEW' : 'INTERNAL (X-RAY)'}
            </button>
          ))}
        </div>
      </div>
      ...
      <div style={{ flex: 1, position: 'relative', display: 'flex' }}>
        ...
        >
          ...
          <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 12, flex: 1 }}>
            <div style={{ fontSize: 11, fontFamily: 'var(--font-mono)', color: 'rgba(255,255,255,0.4)' }}>
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 6 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      ...
                      <div>
                        <div style={{ fontSize: 13, fontWeight: 700, color: isSelected ? '#00d4ff' : '#ffffff' }}>
                          {comp.name}
                        </div>
                  ...
                  {/* Specs Pill */}
                  <div style={{ display: 'flex', gap: 12, fontSize: 10, fontFamily: 'var(--font-mono)', color: 'rgba(255,255,255,0.6)', margin: '8px 0' }}>
