...
export function WelcomeScreen() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // 10. SECTION: THE DIGITAL TWIN LOOP (Standard display without pinned scroll lock)
  ...
  return (
    ...
    >
      ...
      {/* ==============================================================
          ...
          ============================================================== */}
      <section id="sec-twin-loop" className="editorial-section" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
