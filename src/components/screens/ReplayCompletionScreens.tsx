      ...
      >
        ...
        <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap' }}>
          <motion.button
            ...
            onClick={() => {
              useMissionStore.getState().resumeRealtimeAnalysis();
            }}
          ...
          <motion.button
            ...
            className="btn btn-lg"
            style={{ fontSize: 13, letterSpacing: '0.15em', padding: '16px 32px', background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.2)', color: '#fff' }}
          >
          ...
          <motion.button
            ...
            className="btn btn-lg"
            style={{ fontSize: 13, padding: '16px 32px', background: 'rgba(0,212,255,0.08)', border: '1px solid rgba(0,212,255,0.25)', color: '#00d4ff' }}
          >
            ▶ VIEW MISSION REPLAY
          </motion.button>
        </div>
