      ...
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: 10, alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <button
              onClick={() => useMissionStore.getState().setScreen('farewell')}
              className="btn btn-sm"
              style={{ padding: '8px 14px', fontSize: 10, background: 'rgba(155,93,229,0.15)', color: '#d8b4fe', border: '1px solid rgba(155,93,229,0.35)', cursor: 'pointer' }}
              title="Open Farewell & Spacecraft Fate Screen"
            >
              ★ FAREWELL
            </button>
          </div>
            ...
            {[
              ...
              return (
                <button
                  ...
                  style={{
                    padding: '8px 16px',
                    background: isActive ? 'rgba(0,212,255,0.18)' : 'rgba(5,12,25,0.6)',
